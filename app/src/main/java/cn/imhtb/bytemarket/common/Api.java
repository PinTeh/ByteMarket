...
public class Api {
    ...
    public static final String URL_GET_RONG_USER_INFO = BASE + "/user/v1/getUserInfo";

    public static final Type TYPE_RONG_USER_INFO = new TypeToken<ServerResponse<CloudUserInfo>>() {}.getType();

    public static final Type TYPE_BANNER = new TypeToken<ServerResponse<List<Banner>>>() {}.getType();
